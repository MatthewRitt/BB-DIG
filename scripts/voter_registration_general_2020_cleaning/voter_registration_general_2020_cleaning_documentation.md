# Voter Registration 2020 General Cleaning Documentation

## Overview
This script reads the Alabama Voter Registration (ALVR) October 2020 sheet along with the Redistricting Data Hub (RDH) voter file and the cleaned eligible population dataset to produce a cleaned voter registration dataset for the 2020 General Election. The script calculates active and inactive registration counts by race and rates to flag purge risk. The script is narrowed down to the 17 Black Belt Counties detailed in the README file in this repository.
...
* ../../data_storage/clean_data/eligible_population_2020_general/eligible_population_2020_general.csv
