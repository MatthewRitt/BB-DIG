# Voter Registration 2020 General Documentation

## Overview
* This dataset shows voter registration data for the 2020 General Election across the 17 Alabama Black Belt counties. Each row represents one county. This dataset answers the question of everyone who can vote, how many actually registered, and how many are at risk of being removed from the polls. The data is broken down by race.
...
* Census Bureau Citizen Voting Age Population (CVAP) 2020 file pulled through demographics_2020_general.csv (source for eligible population reference)
...
* Inactive status means a voter is on the rolls but is flagged for potential removal due to possibly not voting in recent elections or not responding to confirmation mailings. Inactive voters can still vote, but may need to update their information or cast a provisional ballot.
